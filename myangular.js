...
},{"./compile":5,"./controller":6,"./directives/ng_click":7,"./directives/ng_controller":8,"./directives/ng_transclude":9,"./filter":10,"./http":13,"./http_backend.js":14,"./interpolate":16,"./loader":17,"./parse":18,"./q":19,"./scope":20}],4:[function(require,module,exports){
'use strict';
...
function createInjector(modulesToLoad, strictDi) {
	...
	// Get array list of function's paramter name.
	...
	function createInternalInjector(cache, factoryFn) {
		...
		function invoke(fn, self, locals) {
			...
			// If original function is array, then extract only function part
			if (_.isArray(fn)) {
				fn = _.last(fn);
			}
			// Apply that function and return function value.
