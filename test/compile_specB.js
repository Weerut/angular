...
describe('$compile', function() {
	...
	// 		registerAndCompile('myDirective', '<input my-directive whatever>', function(element, attrs) {
	// 			expect(attrs.whatever).toEqual('');
	// 		});
	// 	});
	// 	it('overrides attributes with ng-attr- versions', function() {
	// 		registerAndCompile('myDirective', '<input my-directive ng-attr-whatever="42" whatever="41">', function(element, attrs) {
	// 			expect(attrs.whatever).toEqual('42');
	// 		});
	// 	});
	// 	it('allows setting attributes', function() {
	// 		registerAndCompile('myDirective', '<my-directive attr="true"></my-directive>', function(element, attrs) {
	...
	// 		registerAndCompile('myDirective', '<input my-directive>', function(element, attrs) {
	...
	// 		registerAndCompile('myDirective', '<my-directive some-attribute="42"></my-directive>', function(element, attrs) {
	...
	// 		registerAndCompile('myDirective', '<my-directive x-some-attribute="42"></my-directive>', function(element, attrs) {
	// 			attrs.$set('someAttribute', '43');
	// 			expect(element.attr('x-some-attribute')).toEqual('43');
	// 		});
	// 	});
	// 	it('does not use ng-attr- prefix in denormalized names', function() {
	// 		registerAndCompile('myDirective', '<my-directive ng-attr-some-attribute="42"></my-directive>', function(element, attrs) {
	// 			attrs.$set('someAttribute', 43);
	// 			expect(element.attr('some-attribute')).toEqual('43');
	// 		});
	// 	});
	...
	// 		registerAndCompile('myDirective', '<div class="my-directive"></div>', function(element, attrs) {
	// 			expect(attrs.hasOwnProperty('myDirective')).toBe(true);
	// 		});
	// 	});
	// 	it('does not add attribute from class without a directive', function() {
	// 		registerAndCompile('myDirective', '<my-directive class="some-class"></my-directive>', function(element, attrs) {
	...
	// 		registerAndCompile('myDirective', '<!-- directive: my-directive and the attribute value -->', function(element, attrs) {
	// 			expect(attrs.hasOwnProperty('myDirective')).toBe(true);
	// 			expect(attrs.myDirective).toEqual('and the attribute value');
	// 		});
	// 	});
	// 	it('allows adding classes', function() {
	// 		registerAndCompile('myDirective', '<my-directive></my-directive>', function(element, attrs) {
	...
	// 		registerAndCompile('myDirective', '<my-directive class="one three four"></my-directive>', function(element, attrs) {
	...
	describe('controllers', function() {
		...
		it('attaches required controllers on controller when using object', function() {  function MyController() { }  var instantiatedController;  var injector = createInjector(['ng', function($compileProvider) {    $compileProvider.directive('myDirective', function() {      return {        scope: {},        controller: MyController      };    });    $compileProvider.directive('myOtherDirective', function() {      return {
			require: {          myDirective: '^'        },        bindToController: true,        controller: function() {          instantiatedController = this;        }      };    });  }]);  injector.invoke(function($compile, $rootScope) {    var el = $('<div my-directive><div my-other-directive></div></div>');    $compile(el)($rootScope);    expect(instantiatedController.myDirective instanceof MyController).toBe(true);  }); });
